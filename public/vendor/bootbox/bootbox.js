...
(function (root, factory) {
  ...
  var templates = {
    dialog:
    '<div class="bootbox modal fade" tabindex="-1" role="dialog" aria-hidden="true">' +
    ...
    closeButton:
    '<button type="button" class="bootbox-close-button close" data-dismiss="modal" aria-label="Close" aria-hidden="true"><span aria-hidden="true">&times;</span></button>',
    form:
