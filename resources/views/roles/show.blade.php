...
@section('content')
	...
	<div class="root">
		...
		@include('misc/models/restore-panel', ['model' => $role])
		...
		@component('misc/page-title')
			@slot('superactions')
				<div class="float-right">
					...
					@include('misc/models/prev-next-rows', ['model' => $role])
				</div>
			@endslot
		...
		<div class="row mb-5 justify-content-center">
			...
			<div class="col-md-4">
				@include('misc/models/additional-information', ['model' => $role])
			</div>
			{{-- END col --}}
		</div>
		{{-- END row --}}
		...
		<div class="row mb-5 justify-content-center">
			<div class="col-md-12">
				@include('misc/models/delete-action', ['model' => $role])
			</div>
			{{-- END col --}}
		</div>
		{{-- END row --}}
